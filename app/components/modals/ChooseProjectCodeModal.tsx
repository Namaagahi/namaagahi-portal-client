...
const ChooseProjectCodeModal = (props: Props) => {
  const { handleModal, data, allFinalCustomers, handleProjectCodeId } = props;
  ...
  const [selectedItem, setSelectedItem] = useState<ProjectCodeObject | null>(
    null
  );
        ...
        <div className="confirmModalContent">
          ...
          <div className="flex flex-col py-12">
            <div className="py-7 border-[1px] border-x-transparent border-y-[#FA9E93] ">
              <div className="flex items-center justify-between">
                ...
                {selectedItem && (
                  <p>
                    {selectedItem.code} - {selectedItem.brand}
                  </p>
                )}
              </div>
                    ...
                    ? data.map((item, index) => {
                        const finalCustomer = allFinalCustomers.find(
                          (finalCustomer: FinalCustomerObject) =>
                            finalCustomer._id === item.finalCustomerId
                        );
                        return (
                          <li
              ...
              {hasChildCode && (
                <>
                  ...
                  <p className="text-red-500">
                    {!jalaliMonth && "ماه را انتخاب کنید!"}
                  </p>
                </>
              )}
            </div>
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className={` ${
                !selectedItem || (hasChildCode && !jalaliMonth)
