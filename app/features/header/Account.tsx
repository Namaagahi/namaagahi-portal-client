...
const Account = () => {
  ...
  const user: UserObject = useSelector(
    (state) => selectUserById(state, id) as UserObject
  );
    ...
    <>
      ...
      >
        {/* <Image
          ...
          height={35}
        /> */}
        <MdAccountCircle className="rounded-full cursor-pointer hover:scale-110 transition-all w-9 h-9" />
          ...
          <div className="accountMenuContainer z-[1000]">
            <ul className="space-y-3">
              <li className="font-medium">
                <div className="accountMenuItem" onClick={handleEditProfile}>
              ...
              <li className="accountMenuLogoutItem " onClick={handleLogout}>
      ...
      {isLogout && <ConfirmModal type={"logout"} handleModal={handleLogout} />}
