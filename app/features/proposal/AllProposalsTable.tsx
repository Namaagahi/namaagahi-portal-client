...
const AllProposalsTable = (props: Props) => {
  ...
  const { data, allInitialCustomers, allUsers, proposal, setProposalId } = props
      ...
      [
        {
          ...
          columns: [
            ...
            },
            {
              ...
              id: 'پروژه',
              cell: info => {
                const project = allInitialCustomers.find(initialCustomer => initialCustomer._id === info.getValue())
                return (
                  <p>{project?.name}</p>
                )
              },
            ...
            },
            {
              ...
              cell: info => {
                ...
                return (
                  <p>{moment.unix(startDate).format('jYYYY-jM-jD')}</p>
                )
              },
            ...
            },
            {
              ...
              cell: info => {
                ...
                return (
                  <p>{moment.unix(endDate).format('jYYYY-jM-jD')}</p>
                )
              },
            ...
            },
            {
              ...
              cell: info => {
                ...
                const filteredUsers = allUsers.filter(user => assignedUsers.includes(user._id))
              ...
              cell: (info) => {
                ...
                return (
                  ...
                  {(isMaster || isAdmin || isProjectManager)?
                    <p className="px-6 flex items-center justify-center gap-5" onClick={() => setProposalId(row.id)}>
