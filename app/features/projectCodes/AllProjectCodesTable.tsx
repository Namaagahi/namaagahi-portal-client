...
const AllProjectCodesTable = (props: any) => {
    ...
    const [isDeleteProjectCode, setIsDeleteProjectCode] = useState<boolean>(false)
    const [isEditProjectCode, setIsEditProjectCode] = useState<boolean>(false)

    const handleDeleteProjectCode = () => setIsDeleteProjectCode(!isDeleteProjectCode)
          ...
          [
            {
              ...
              columns: [ 
                ...
                },
                {
                    ...
                    id: 'مشتری',
                    cell: info => {
                        const thisCustomer = allFinallCustomers.find((finalCustomer: FinalCustomerObject) => finalCustomer._id === info.getValue())
                        return (
                ...
                },
                {
                    ...
                    cell: (info) => {
                      ...
                      return (
                        <div className="flex items-center justify-center gap-2" onClick={() => setProjectCodeId(row.id)}>
