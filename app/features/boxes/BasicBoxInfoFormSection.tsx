...
const BasicBoxInfoFormSection = (props: Props) => {
  ...
  const handleChooseProjectCodeModal = () =>
    setIsProjectCodeModal(!isProjectCodeModal);
  ...
  const projectCode = allProjectCodes.find(
    (projectCode) => projectCode._id === projectCodeId
  );
