...
export const initialCustomersApiSlice = initialCustomerApiSliceTag.injectEndpoints({
  ...
  endpoints: (builder: any) => ({
    ...
    createNewInitialCustomer: builder.mutation({
      ...
      query: (initialInitialCustomer: any) => ({
        url: '/initialCustomers',
        method: 'POST',
        body: { ...initialInitialCustomer }
      }),

      invalidatesTags: [{ type: 'InitialCustomer', id:'LIST' }]
    }),

    updateInitialCustomer: builder.mutation({
...
export const { useGetAllInitialCustomersQuery, useCreateNewInitialCustomerMutation, useUpdateInitialCustomerMutation, useDeleteInitialCustomerMutation } = initialCustomersApiSlice
