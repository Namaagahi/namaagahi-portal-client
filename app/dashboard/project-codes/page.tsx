...
const ProjectCodes = () => {
  ...
  return (
    <>
      <PageTitle name={"کدهای شناسه"} />

      <div className="flex items-center justify-between gap-3">
        <SearchContainer />
        <Button
          onClickHandler={handleNewProjectCodeModal}
          title="شناسه کار جدید"
        />
      </div>
      {!allProjectCodes[0] ? (
        <div className="flex flex-col justify-center items-center min-h-screen gap-3">
          <p className="text-xl">شما هیچ شناسه کار ای ثبت نکرده اید</p>

          <p>
            برای ایجاد شناسه کار جدید جدید
            <span
