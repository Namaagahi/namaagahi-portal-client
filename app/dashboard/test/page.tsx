...
import { selectAllBoxes, useCreateNewBoxMutation, useGetAllBoxesQuery } from "@/app/features/boxes/boxesApiSlice"
...
const BasicInfoFormSection = dynamic(
  () => import('@/app/features/boxes/BasicInfoFormSection'),
  { ssr: false }
)
const StructuresFormSection = dynamic(
  () => import('@/app/features/boxes/StructuresFormSection'),
  { ssr: false }
)
